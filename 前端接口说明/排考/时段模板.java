/** 时段模板 */
     ...
     * 正确返回：{"success":true,"total":"总记录数","dataList":[TimeModel]}
     *
     */
     ...
     *
     * 出错返回：{"success":false,"type":1或2,"message":"错误信息"} 1已知错误、2未知错误
     * 正确返回：{"success":true,"data":{TimeModel}}
     *
     */
