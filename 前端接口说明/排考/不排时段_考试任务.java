/** 考试任务不排考时段 */
     ...
     * 使用者：
     *
     * URL：exmTaskTimeEx!query.action
     *
     * 参数
     * start    可选   记录开始位置
     * limit    可选   获取记录数量
     ...
     * 正确返回：{"success":true,"total":"总记录数","dataList":[ExamTaskTimeExcept]}
     *
     */
     ...
     * 使用者：教师
     *
     * URL：exmTaskTimeEx!query2.action
     *
     * 参数
     * start         可选   记录开始位置
     * limit         可选   获取记录数量
     ...
     *
     * 出错返回：{"success":false,"type":1或2,"message":"错误信息"} 1已知错误、2未知错误
     * 正确返回：{"success":true,"total":"总记录数","dataList":[V_ExamTaskTimeExcept]}
     *
     */
     ...
     * 使用者：高级用户
     *
     * URL：exmTaskTimeEx!newRec.action
     *
     * 参数
     * taskId  必需   考试任务Id
     * timeId  必需   考试时段Id
