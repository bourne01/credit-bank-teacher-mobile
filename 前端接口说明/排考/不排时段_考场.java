/** 考场不排考时段 */
     ...
     * 正确返回：{"success":true,"total":"总记录数","dataList":[ExamRoomTimeExcept]}
     *
     */
     ...
     * 使用者：教师
     *
     * URL：exmRomTimeEx!query2.action
     *
     * 参数
     * start         可选   记录开始位置
     * limit         可选   获取记录数量
     ...
     *
     * 出错返回：{"success":false,"type":1或2,"message":"错误信息"} 1已知错误、2未知错误
     * 正确返回：{"success":true,"total":"总记录数","dataList":[V_ExamRoomTimeExcept]}
     *
     */
     ...
     * 使用者：高级用户
     *
     * URL：exmRomTimeEx!newRec.action
     *
     * 参数
     * exmRomId    必需   考场Id
     * timeId      必需   考试时段Id
